    ...
    Promise.all(
        ...
        articles.forEach(function(article) {
            if (article) {
                ...
                html += createHomepageCard(processedArticle);
                hasContent = true;
            }
        });
    ...
    Promise.all(
        ...
        articles.forEach(function(article) {
            if (article) {
                ...
                html += createHomepageCard(processedArticle, "JK");
            } else {
    ...
    Promise.all(
        ...
        articles.forEach(function(article) {
            if (article) {
                ...
                html += createHomepageCard(processedArticle, "INTL");
            } else {
    ...
    Promise.all(
        ...
        articles.forEach(function(article) {
            if (article) {
                ...
                html += createHomepageCard(processedArticle, "HR");
            } else {
                    ...
                    html += `
                        <p>
                            <figure class="${alignClass}">
                                <img src="${data.heroImage.src}" alt="${data.heroImage.caption || 'Logo'}">
...
function initArticlePage() {
    ...
    fetch("content/" + id + ".json")
        ...
        .then(function(article) {
            ...
            renderFullArticlePage(processedArticle);
            initShareTooltip();
        })
        .catch(function() {
